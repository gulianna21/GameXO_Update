...
public class GameLogic_SinglePlayerManager extends CommonGameLogic {
    ...
    private int checkString(String[][] mass) {
        for (int i = 0; i < mass.length; i++) {
            for (int j = 0; j < 1; j++) {
                if (mass[i][j] != null && mass[i][j + 1] != null && mass[i][j].equals(mass[i][j + 1]) &&
                        mass[i][j + 2] == null) {
                    return i * 3 + 2;
                }
                if (mass[i][j] != null && mass[i][j + 2] != null && mass[i][j].equals(mass[i][j + 2]) &&
                        mass[i][j + 1] == null) {
                    return i * 3 + 1;
                }
                if (mass[i][j + 1] != null && mass[i][j + 2] != null &&
                        mass[i][j + 1].equals(mass[i][j + 2]) && mass[i][j] == null) {
                    return i * 3;
                }
            }
        }
    ...
    private int checkUp(String[][] mass) {
        for (int i = 0; i < mass.length; i++) {
            for (int j = 0; j < 1; j++) {
                if (mass[j][i] != null && mass[j + 1][i] != null && mass[j][i].equals(mass[j + 1][i]) &&
                        mass[j + 2][i] == null) {
                    return 6 + i;
                }
                if (mass[j][i] != null && mass[j + 2][i] != null && mass[j][i].equals(mass[j + 2][i]) &&
                        mass[j + 1][i] == null) {
                    return 3 + i;
                }
                if (mass[j + 1][i] != null && mass[j + 2][i] != null &&
                        mass[j + 1][i].equals(mass[j + 2][i]) && mass[j][i] == null) {
                    return i;
                }
            }
        }
    ...
    private int checkDiagonal(String[][] mass) {
        if (mass[0][0] != null && mass[1][1] != null && mass[0][0].equals(mass[1][1]) &&
                mass[2][2] == null)
            return 8;
        if (((mass[0][0] != null && mass[2][2] != null && mass[0][0].equals(mass[2][2])) ||
                (mass[0][2] != null && mass[2][0] != null && mass[0][2].equals(mass[2][0]))) &&
                mass[1][1] == null)
            return 4;
        if (mass[1][1] != null && mass[2][2] != null && mass[1][1].equals(mass[2][2]) &&
                mass[0][0] == null)
            return 0;

        if (mass[0][2] != null && mass[1][1] != null && mass[0][2].equals(mass[1][1]) &&
                mass[2][0] == null)
            return 6;
        if (mass[1][1] != null && mass[2][0] != null && mass[1][1].equals(mass[2][0]) &&
                mass[0][2] == null)
            return 2;
        return -1;
    }
